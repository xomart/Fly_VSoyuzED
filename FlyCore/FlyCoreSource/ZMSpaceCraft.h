...
public:
	...
	//-------------------------------------------------------------------------
	// Parameters for optional rotational dynamics (external equations).
	double m_RotJ[3];
	double m_RotJinv[3];
	double m_RotMoment[3];
	bool   m_RotQuatNormalize;
...
public :
	...
	// 	
	// ------------------------------------------------------------------------
	// Rotational dynamics support through external equations
	// state: q0,q1,q2,q3,wx,wy,wz
	// ------------------------------------------------------------------------
	void SetRotInertiaDiag(double Jx, double Jy, double Jz);
	void SetRotConstantMoment(double Mx, double My, double Mz);
	void SetRotQuatNormalization(bool On);
	void FillRotExternalDefinition(ZCExternalEquationsDefinition& EED) const;
	void FillRotInitialState(double* Xrot, const double* q, const double* w, bool Normalize=true) const;
